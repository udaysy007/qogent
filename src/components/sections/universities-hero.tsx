...
export function UniversitiesHero() {
  return (
    <section className="relative min-h-[40vh] w-full overflow-visible">
      {/* Background Glow */}
      ...
      <div className="container relative z-10 mx-auto grid min-h-[40vh] grid-cols-1 items-center gap-6 px-4 py-8 md:grid-cols-2 lg:px-6">
        ...
        {/* Right Column - Globe */}
        <div className="relative order-first md:order-last animate-appear opacity-0 [animation-delay:600ms]">
          <Globe />
        </div>
      </div>
