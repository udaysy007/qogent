    ...
    <section className="py-20">
      <div className="container">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
          <span className="text-destructive dark:text-red-400">Private Universities</span>, not{" "}
          <span className="text-primary">Merit-Based Admissions</span>
        </h2>

        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* Traditional Process */}
          <div className="rounded-xl border border-destructive/20 dark:border-red-400/30 bg-destructive/5 dark:bg-red-400/10 p-6">
            <div className="flex items-center gap-2 mb-4">
              <X className="text-destructive dark:text-red-400" />
              <h3 className="text-xl font-semibold text-destructive dark:text-red-400">
                Other Consultants
              </h3>
            </div>
            <ul className="space-y-4 text-destructive dark:text-white">
