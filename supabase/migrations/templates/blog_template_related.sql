...
BEGIN
  -- Get post IDs
  SELECT id INTO blog_post_id FROM blog_posts WHERE slug = '[slug-with-hyphens]';
  SELECT id INTO related_post_id1 FROM blog_posts WHERE slug = '[related-post-1-slug]';
  SELECT id INTO related_post_id2 FROM blog_posts WHERE slug = '[related-post-2-slug]';
