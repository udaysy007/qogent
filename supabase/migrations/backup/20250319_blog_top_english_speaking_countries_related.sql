...
BEGIN
  -- Get post IDs
  SELECT id INTO blog_post_id FROM blog_posts WHERE slug = 'top-english-speaking-countries-higher-education';
  SELECT id INTO related_post_id1 FROM blog_posts WHERE slug = 'most-affordable-countries-higher-education-cost-analysis';
  SELECT id INTO related_post_id2 FROM blog_posts WHERE slug = 'choosing-study-destination-step-by-step-guide';
