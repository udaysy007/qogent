...
BEGIN
  -- Get post IDs
  SELECT id INTO blog_post_id FROM blog_posts WHERE slug = 'building-international-career-study-global-professional';
  SELECT id INTO related_post_id1 FROM blog_posts WHERE slug = 'global-job-markets-best-countries-post-study-work';
