...
BEGIN
  -- Get post IDs
  SELECT id INTO blog_post_id FROM blog_posts WHERE slug = 'portfolio-development-guide-creative-technical-programs';
  SELECT id INTO related_post_id1 FROM blog_posts WHERE slug = 'creating-perfect-academic-cv-international-standards-examples';
  SELECT id INTO related_post_id2 FROM blog_posts WHERE slug = 'how-to-write-a-powerful-statement-of-purpose-a-global-template';
