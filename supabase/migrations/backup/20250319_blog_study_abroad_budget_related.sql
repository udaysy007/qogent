...
BEGIN
  -- Get post IDs
  SELECT id INTO blog_post_id FROM blog_posts WHERE slug = 'study-abroad-budget-universal-planning-template';
  SELECT id INTO related_post_id1 FROM blog_posts WHERE slug = 'international-student-banking-guide';
  SELECT id INTO related_post_id2 FROM blog_posts WHERE slug = 'global-scholarship-guide-international-students';
