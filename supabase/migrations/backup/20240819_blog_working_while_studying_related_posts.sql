...
BEGIN
  -- Get post IDs
  SELECT id INTO blog_post_id FROM blog_posts WHERE slug = 'working-while-studying-abroad-country-wise-policies';
  SELECT id INTO related_post_id1 FROM blog_posts WHERE slug = 'most-affordable-countries-for-higher-education';
  SELECT id INTO related_post_id2 FROM blog_posts WHERE slug = 'how-to-create-a-study-abroad-budget';
  SELECT id INTO related_post_id3 FROM blog_posts WHERE slug = 'choosing-your-study-destination';
